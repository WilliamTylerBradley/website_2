...
This post continues the work from the [previous one](https://www.willtybrad.com/2020-04-16-website-design-part-1/).  This code takes the saved data and creates the images.  The first two sections set up the rest of the work.
